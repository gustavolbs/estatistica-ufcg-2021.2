...
Base de dados é uma planilha com 7 variáveis, pegando dos aspectos de uso de ebook, livro impresso até a disponibilidade dos ebooks para uso nas disciplinas durante a graduação na ufcg. 
```{r instala_e_ou_carrega_pacotes_e_instancia_dados, echo=FALSE, warning=FALSE}
library(ggplot2)
library (car)

matrix <- readxl::read_excel("C:\\Users\\diego\\Desktop\\formsGoogle.xlsx", sheet = 1)
matrix


matrix <- matrix %>% mutate(interesting1=recode(interesting, "concordo totalmente." = 1))
