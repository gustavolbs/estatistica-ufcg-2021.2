...
_a) (µ − 1, 64σ; µ + 1, 64σ);_

**Resposta**

_para simplificar  atribuimos x = µ − 1, 64σ e y = µ + 1, 64σ_

_portanto :_

_Zy = 1,64 e Zx = - 1.64_

_resolvendo P(Zx < Z < Zy)_

_P(Zx < Z < Zy) = P(-1,64 < Z < 1,64)_

_.              =  P(Z < 1,64) - P(Z < - 1,64)_

_.              = 0.9495 - 0.0505 = 0.8990_

_b) (µ − 1, 96σ; µ + 1, 96σ);_

**Resposta**

_para simplificar  atribuimos x = µ − 1, 96σ e y = µ + 1, 96σ_
...
_P(Zx < Z < Zy) = P(-1, 96 < Z < 1, 96)_

_.              =  P(Z < 1, 96) - P(Z < - 1, 96)_

_.              = 0.9750 - 0.0250 = 0.9500_

_c) (µ − 2, 57σ; µ + 2, 57σ);_

**Resposta**

_para simplificar  atribuimos x = µ − 2,57 σ e y = µ + 2,57 σ_
...
_P(Zx < Z < Zy) = P( 2,57  < Z < 2,57)_

_.              =  P(Z < 2,57) - P(Z < - 2,57 )_

_.              = 0.9772 - 0.0227 = 0.9545_
